...
public class ReduceMain {
    ...
    public static void main(String[] args) {
        ...
        List<gr.aueb.cf.ch18.streams.Product> products = new ArrayList<>(List.of(new gr.aueb.cf.ch18.streams.Product("Apples" , 12.5, 100),
                new gr.aueb.cf.ch18.streams.Product("Oranges", 8.2,100)
